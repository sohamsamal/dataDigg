...
//
//  Created by Satish Nerlekar on 07/05/18.
...
final class HAQuizDataManager{
    ...
    func mark(question: HAQuestion!, asRedFor category:HACategory!){
        ...
        //attemptedQuestions = removeDuplicate(arr: attemptedQuestions)
    ...
    func markW(question: HAQuestion!, asRedFor category:HACategory!){
        ...
        //wrongQuestions = removeDuplicate(arr: wrongQuestions)
    ...
    func attemptedQuestionsCount(for category:HACategory!) -> Int
    {
        ...
        if (FileManager.default.fileExists(atPath: filePath))
        {
            var attemptedQuestions = NSMutableArray.init(contentsOfFile: filePath)!
            //attemptedQuestions = removeDuplicate(arr: attemptedQuestions)
    ...
    func removeDuplicate(arr:NSMutableArray)->NSMutableArray {
