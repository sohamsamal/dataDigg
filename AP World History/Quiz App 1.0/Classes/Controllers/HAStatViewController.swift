...
//
//  Created by Soham Samal on 11/18/18.
...
class HAStatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, GADFullScreenContentDelegate, GKGameCenterControllerDelegate {
 ...
 @IBOutlet weak var homeButton: UIButton!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor.init(hexString: "#fdf5e6")
        self.navigationController?.navigationBar.barTintColor = UIColor.init(hexString: "#fdf5e6")
        ...
        if HASettings.sharedInstance.requireAdsDisplay(){
            ...
            ads.start { [self] status in
                ...
                let request = GADRequest()
                    GADInterstitialAd.load(withAdUnitID:"ca-app-pub-8358263348683173/5816074241",
                                                request: request,
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell2.bgImageView.backgroundColor = UIColor.init(hexString: "#fdf5e6")
